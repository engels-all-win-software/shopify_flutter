...
class _Article extends Article {
   _Article({this.author, final  List<Comment>? commentList, this.content, this.contentHtml, this.excerpt, this.excerptHtml, this.handle, this.id, this.image, this.publishedAt, final  List<String>? tags, this.title, this.onlineStoreUrl}): _commentList = commentList,_tags = tags,super._();
