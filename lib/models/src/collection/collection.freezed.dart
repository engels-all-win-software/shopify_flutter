...
class _Collection extends Collection {
   _Collection({required this.title, required this.id, required this.products, required final  List<Metafield> metafields, this.cursor, this.description, this.descriptionHtml, this.handle, this.updatedAt, this.image}): _metafields = metafields,super._();
