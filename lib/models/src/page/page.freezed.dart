...
class _Page extends Page {
   _Page({required this.body, required this.bodySummary, required this.createdAt, required this.handle, required this.id, required this.title, required this.updatedAt, required this.onlineStoreUrl}): super._();
