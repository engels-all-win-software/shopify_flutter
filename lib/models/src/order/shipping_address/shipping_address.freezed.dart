...
class _ShippingAddress implements ShippingAddress {
   _ShippingAddress({required this.name, required this.id, required this.lastName, required this.address1, required this.city, required this.country, this.firstName, this.address2, this.company, this.countryCodeV2, this.latitude, this.longitude, this.phone, this.province, this.provinceCode, this.zip});
