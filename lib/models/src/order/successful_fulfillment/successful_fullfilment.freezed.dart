...
class _SuccessfulFullfilment extends SuccessfulFullfilment {
   _SuccessfulFullfilment({required this.trackingCompany, required final  List<SuccessfulFullfilmentTrackingInfo>? trackingInfo}): _trackingInfo = trackingInfo,super._();
