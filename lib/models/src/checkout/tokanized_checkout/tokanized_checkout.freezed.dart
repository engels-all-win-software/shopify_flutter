...
class _TokanizedCheckout extends TokanizedCheckout {
   _TokanizedCheckout({@JsonKey(name: 'id') required this.paymentId, required this.amountV2, required this.test, required this.ready, this.nextActionUrl, this.errorMessage, @JsonKey(name: 'checkout', fromJson: _checkoutIdFromJson) this.checkoutId}): super._();
