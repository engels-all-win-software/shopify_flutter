...
class _Customer extends Customer {
   _Customer({required this.id, required this.email, required this.phone, required this.firstName, required this.lastName, required this.displayName, required this.defaultAddress, required this.numberOfOrders, required this.acceptsMarketing}): super._();
