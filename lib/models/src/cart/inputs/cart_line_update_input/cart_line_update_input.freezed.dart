...
class _CartLine extends CartLineUpdateInput {
   _CartLine({this.id, required this.merchandiseId, required this.quantity, this.sellingPlanId, final  List<AttributeInput?> attributes = const []}): _attributes = attributes,super._();
