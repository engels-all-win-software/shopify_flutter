...
class _CartBuyerIdentityInput extends CartBuyerIdentityInput {
   _CartBuyerIdentityInput({required this.email, this.phone, this.countryCode, this.customerAccessToken, final  List<DeliveryAddressInput?> deliveryAddressPreferences = const []}): _deliveryAddressPreferences = deliveryAddressPreferences,super._();
