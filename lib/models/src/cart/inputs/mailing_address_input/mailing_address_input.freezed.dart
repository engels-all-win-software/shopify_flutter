...
class _MailingAddressInput extends MailingAddressInput {
   _MailingAddressInput({required this.address1, this.address2, this.city, this.company, this.country, this.firstName, this.lastName, this.phone, this.province, this.zip}): super._();
