...
class _Line extends Line {
   _Line({this.id, this.quantity, this.cost, this.merchandise, this.variantId, final  List<CartDiscountAllocation?>? discountAllocations, this.sellingPlanAllocation, final  List<Attribute?>? attributes}): _discountAllocations = discountAllocations,_attributes = attributes,super._();
