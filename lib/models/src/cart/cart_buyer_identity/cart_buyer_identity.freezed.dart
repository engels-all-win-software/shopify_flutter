...
class _CartBuyerIdentity extends CartBuyerIdentity {
   _CartBuyerIdentity({this.email, this.phone, this.countryCode, this.preferences, this.customer, final  List<MailingAddress?>? deliveryAddressPreferences}): _deliveryAddressPreferences = deliveryAddressPreferences,super._();
