...
class _SellingPlan extends SellingPlan {
   _SellingPlan({required this.id, required this.name, this.description, this.recurringDeliveries, this.checkoutCharge, final  List<PriceAdjustments> priceAdjustments = const [], final  List<SellingPlanOption> options = const []}): _priceAdjustments = priceAdjustments,_options = options,super._();
