...
class _Metafield extends Metafield {
   _Metafield({required this.id, required this.namespace, required this.key, required this.value, required this.type, this.description, final  Map<String, dynamic>? reference}): _reference = reference,super._();
